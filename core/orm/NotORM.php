...
* moved to class.JsonSerializable.php  for autoloding
	if (!interface_exists('JsonSerializable')) {
		interface JsonSerializable extends Json_Serializable{
			function jsonSerialize();
		}
	}
*/

include_once CORE. "orm/NotORM/Structure.php";
include_once CORE. "orm/NotORM/Cache.php";
include_once CORE. "orm/NotORM/Literal.php";
include_once CORE. "orm/NotORM/Result.php";
include_once CORE. "orm/NotORM/MultiResult.php";
include_once CORE. "orm/NotORM/Row.php";
